...
class TestDagValidation:
    ...
    #     """
    #         Verify if there is the right of DAGs in the dag folder
    ...
    def test_nb_tasks(self, dag):
        ...
        assert nb_tasks == self.EXPECTED_NUMBER_OF_DAGS, "Wrong number of tasks, {0} expected, got {1}".format(self.EXPECTED_NUMBER_OF_DAGS, nb_tasks)
